...
\usepackage{babel}
\begin{document}
\materia{Se\~nales Aleatorias}
\titulo{Trabajo Pr\'actico de Simulaci\'on N$^{\circ}$ 1}
\trabajo{}
\fecha{3 de Mayo 2019} %Aca va la fecha. Si lo dejan asi muestra la fecha de compilacion.
\grupo{2}
